...
const RecipeItem = ({ recipe, onToggleFavorite, onDeleteRecipe }) => (
  <li className={style.list}>
    ...
    <p className="className='display-10'">{style.calories100g}{recipe.calories100g} kcal/100g</p>
    <p className="className='display-10'"><FontAwesomeIcon icon={faClock} style={{ color: 'gray' }}  />{style.totalCookingTimeMinutes}
